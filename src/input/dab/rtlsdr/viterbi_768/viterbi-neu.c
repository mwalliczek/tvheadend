...
static int     costTable [16];
static int	*stateSequence;
static int	**transCosts;
static int	**history;
static 	int16_t blockLength;
...
void	computeCostTable (int16_t sym_0,
                                          int16_t sym_1,
...
void	deconvolve	(struct v * vp, int16_t *sym, uint8_t *bitBuffer) {
int	prev_0, prev_1;
int	costs_0, costs_1;
int	i;
 ...
 */
uint8_t	bitFor (int state, int poly, int bit) {
int  theRegister;
uint8_t resBit = 0;
int	i;
//
