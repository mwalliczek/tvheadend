...
char *nameFor (int32_t serviceId) {
int16_t i;
...
/*
void	dataforDataService (char *s, packetdata *d) {
	dataforDataService (s, d, 0);
}

void	dataforDataService (char *s,
	                                   packetdata *d,
	                                   int16_t compnr) {
int16_t	j;
serviceId *selectedService;
	...
	d	-> defined	= 0;	// always a decent default
...
void	dataforAudioService (char *s, audiodata *d) {
	dataforAudioService (s, d, 0);
}

void	dataforAudioService (char *s,
